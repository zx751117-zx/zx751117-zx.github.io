...
!(function (global, undefined) {
    ...
    function doResize() {
        ...
        Q.removeClass(pageAccreditEl, 'border_left');
            ...
            Q.throttle({
                fn: function () {
                    ...
                    if (maxWidth < MAX) {
                        ...
                        Q.addClass(pageAccreditEl, 'border_left');
    ...
    function initUI(){
        ...
        if(Q.authsCount <= 0) {
            ...
            Q.removeClass(document.getElementsByClassName('page_accredit')[0], 'border_left');
