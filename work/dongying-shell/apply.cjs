...
const cheerio = require('../home-copy/node_modules/cheerio');
...
const routes = {'index.html':'index.html','product.html':'h-col-103.html','solution.html':'h-col-137.html','news.html':'h-col-132.html','company.html':'h-col-101.html','contact.html':'#dongying-contact'};
